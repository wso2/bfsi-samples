...
public class SuccessResponseIssueRefreshTokenGeneration implements Serializable {
    private static final long serialVersionUID = 1L;
    private String responseId;
    private StatusEnum status;
    private SuccessResponseIssueRefreshTokenGenerationData data;

    public SuccessResponseIssueRefreshTokenGeneration() {
    }
    ...
    @JsonProperty("data")
    @Valid
    public SuccessResponseIssueRefreshTokenGenerationData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(SuccessResponseIssueRefreshTokenGenerationData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        SuccessResponseIssueRefreshTokenGeneration successResponseIssueRefreshTokenGeneration =
                (SuccessResponseIssueRefreshTokenGeneration) o;
        return Objects.equals(this.responseId, successResponseIssueRefreshTokenGeneration.responseId) &&
                Objects.equals(this.status, successResponseIssueRefreshTokenGeneration.status) &&
                Objects.equals(this.data, successResponseIssueRefreshTokenGeneration.data);
    }
    ...
    public String toString() {
        ...
        sb.append("class SuccessResponseIssueRefreshTokenGeneration {\n");
