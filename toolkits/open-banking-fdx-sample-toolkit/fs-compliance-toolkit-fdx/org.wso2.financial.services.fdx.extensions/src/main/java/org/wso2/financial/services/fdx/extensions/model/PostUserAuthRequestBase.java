...
public class PostUserAuthRequestBase implements Serializable {
    private static final long serialVersionUID = 1L;
    private String requestId;
    private PostUserAuthRequestBaseData data;

    public PostUserAuthRequestBase() {
    }
    ...
    @JsonProperty("data")
    @Valid
    public PostUserAuthRequestBaseData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(PostUserAuthRequestBaseData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        PostUserAuthRequestBase postUserAuthRequestBase = (PostUserAuthRequestBase) o;
        return Objects.equals(this.requestId, postUserAuthRequestBase.requestId) &&
                Objects.equals(this.data, postUserAuthRequestBase.data);
    }
    ...
    public String toString() {
        ...
        sb.append("class PostUserAuthRequestBase {\n");
