...
public class EventSubscriptionRequest implements Serializable {
    ...
    public enum EventTypeEnum {
        ...
        SINGLE_SUBSCRIPTION_RETRIEVAL(String.valueOf("SingleSubscriptionRetrieval")),
        BULK_SUBSCRIPTION_RETRIEVAL(String.valueOf("BulkSubscriptionRetrieval")),
        SUBSCRIPTION_RETRIEVAL_FOR_EVENT_TYPES(String.valueOf("SubscriptionRetrievalForEventTypes")),
        SUBSCRIPTION_UPDATE(String.valueOf("SubscriptionUpdate")),
        SUBSCRIPTION_DELETE(String.valueOf("SubscriptionDelete"));
