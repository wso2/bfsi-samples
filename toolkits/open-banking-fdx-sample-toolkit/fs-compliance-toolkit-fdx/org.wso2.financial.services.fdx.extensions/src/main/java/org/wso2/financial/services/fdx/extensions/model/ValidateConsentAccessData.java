...
public class ValidateConsentAccessData implements Serializable {
    ...
    @ApiModelProperty(
            value = "The receipt used by Third parties which includes detailed information on data access request")
