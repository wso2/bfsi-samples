...
public class SuccessResponseTokenGeneration implements Serializable {
    private static final long serialVersionUID = 1L;
    private String responseId;
    private StatusEnum status;
    private SuccessResponseTokenGenerationData data;

    public SuccessResponseTokenGeneration() {
    }
    ...
    @JsonProperty("data")
    @Valid
    public SuccessResponseTokenGenerationData getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(SuccessResponseTokenGenerationData data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        SuccessResponseTokenGeneration successResponseTokenGeneration = (SuccessResponseTokenGeneration) o;
        return Objects.equals(this.responseId, successResponseTokenGeneration.responseId) &&
                Objects.equals(this.status, successResponseTokenGeneration.status) &&
                Objects.equals(this.data, successResponseTokenGeneration.data);
    }
    ...
    public String toString() {
        ...
        sb.append("class SuccessResponseTokenGeneration {\n");
